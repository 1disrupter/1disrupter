  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-4" data-testid="alerts-page">
      <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-3">
              ...
              {alerts.length > 0 && (
                <Button
                  ...
                  size="sm"
                  onClick={clearAlerts}
                  className="rounded-full border-zinc-800 text-[10px] h-7 px-3 text-zinc-400"
            ...
            <Card className="bg-gradient-to-r from-[#7B61FF]/5 to-[#00FF94]/5 border-[#7B61FF]/20 mb-6" data-testid="upgrade-prompt">
              <CardContent className="p-6 text-center">
                ...
                <Button
                  ...
                  className="rounded-full bg-[#7B61FF] hover:bg-[#7B61FF]/80 text-white text-xs"
                  data-testid="upgrade-alerts-btn"
                >
        ...
        {!showUpgradePrompt && alerts.length === 0 && (
