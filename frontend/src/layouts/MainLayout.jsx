        ...
        >
          ...
          >
            ...
            <nav className="flex flex-col gap-3 text-white mt-6">
              ...
              <a
                href="/owner"
                className="rounded-2xl border border-fuchsia-500/20 bg-fuchsia-500/5 px-4 py-3 text-white hover:bg-fuchsia-500/15 hover:border-fuchsia-400/30 hover:shadow-[0_0_20px_rgba(255,0,200,0.2)] transition-all duration-300"
              >
                🏢 Venue Owner
              </a>
              ...
              <a
                href="/admin"
                className="rounded-2xl border border-red-500/20 bg-red-500/5 px-4 py-3 text-white hover:bg-red-500/15 hover:border-red-400/30 transition-all duration-300"
              >
                ⚙️ Admin
              </a>
